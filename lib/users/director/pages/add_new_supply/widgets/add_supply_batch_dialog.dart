...
class AddSupplyBatchDialog extends StatefulWidget {
  ...
  @override
  State<AddSupplyBatchDialog> createState() => _AddSupplyBatchDialogState();
}

class _AddSupplyBatchDialogState extends State<AddSupplyBatchDialog> {
  int productId = -1;
